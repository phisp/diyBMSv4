...
(____/(____) (__) (____/(_/\/\_)(___/    \/   (_)
  ...
  This code runs on ESP-8266 WEMOS D1 PRO and compiles with Arudino IDE environment

  Arduino settings
  (NodeMCU 1.0 (ESP-12E module), Flash 4M (3MSPIFF), CPU 80MHZ) or appropriate
  ...
  Open the .zip file and extract the folder to your Arduino libraries folder.
  ...
  Upload Sketch: Tools -> Erase Flash: "All Flash Contents", if you need new Wifi Settings!
  Connect Wifi to DIY_BMS_CONTROLLER -> Set IP fixed to 192.168.4.2 -> open IP 192.168.4.1 in Browser -> ESP will restart after settings are saved
*/
